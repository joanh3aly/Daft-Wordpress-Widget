<?php
/*
 * The plugin uses bootstrap css by default and jquery, remove if not necessary
 */
?>
...
<form method="POST" action="" class="daft-search">
    <fieldset>
        <label>Ad Type</label>
